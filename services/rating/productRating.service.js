...
const { syncProductRatingSummary } = require('../common/productFeedbackSync.service');
const recalculateProductRating = async (productId, session = null) => syncProductRatingSummary(productId, session);
